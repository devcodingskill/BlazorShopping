...
namespace Shopping.API.Data
{
    ...
    {
        //Constructor passing the options to the base class
        ...
        //after we connect to the database, we don't need seed the database with some dummy data
        //Create the dammy data for the products and users
